...
public class CommentController {
    ...
    // It add the user and image fields and then sends it off the service layer for
    // persistence.
    @RequestMapping(value = "/image/{imageId}/{imageTitle}/comments", method = RequestMethod.POST)
    public String createComment(@PathVariable("imageTitle") String title, @PathVariable("imageId") Integer id,
