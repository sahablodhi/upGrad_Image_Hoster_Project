...
// mentioned as 'images'. Hence the table named 'images' will be created in the
// database with all the columns mapped to all the attributes in 'Image' class
@Table(name = "images")
public class Image {
    ...
    // This attribute contains the list of all the comments of an image
